...
public class DashboardXxmOtherTableValues {
	...
	public DashboardXxmOtherTableValues(double totCustomers, double q1cusPen, double q1techCount, 
			...
			double q1bListBN, double q1revSec, double q1bListSec, double cwp,
